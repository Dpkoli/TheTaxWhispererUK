...
import { CapitalGainsTaxForm } from "@/components/compute/capital-gains-tax-form";
import { auth } from "@/lib/auth";

export const dynamic = "force-dynamic";

export default async function CapitalGainsTaxComputePage() {
